...
class NeptuneScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMoveToView(view: SKView) {
        ...
        // enemy timer
        _ = NSTimer.scheduledTimerWithTimeInterval(0.5, target: self, selector: #selector(NeptuneScene.spawnEnemy), userInfo: nil, repeats: true)
    ...
    func spawnEnemy() {
        ...
        if random_num % 2 == 0 {
            ...
            enemy = Enemy(type: "bee_red", frames: 0.25, speed:2.0)
        }
