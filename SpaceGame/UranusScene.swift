...
class UranusScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMoveToView(view: SKView) {
        ...
        // enemy timer
        _ = NSTimer.scheduledTimerWithTimeInterval(0.5, target: self, selector: #selector(UranusScene.spawnEnemy), userInfo: nil, repeats: true)
    ...
    func spawnEnemy() {
        ...
        if random_num % 2 == 0 {
            ...
            enemy = Enemy(type: "spider_red", frames: 0.25, speed:1.6)
        }
        else {
            
            enemy = Enemy(type: "bee_blue", frames: 0.25, speed:2.0)
        }
